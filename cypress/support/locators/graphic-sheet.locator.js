export default {
  ...
  PR:
   '[data-ehr-path="vital_signs_record_sheet/vital_signs/pulse_heart_beat/rate"]',
  RR:
   '[data-ehr-path="vital_signs_record_sheet/vital_signs/respiration/rate"]',
  BT:
   '[data-ehr-path="vital_signs_record_sheet/vital_signs/body_temperature/temperature"]',
  SPO2:
   '[aria-labelledby="vital_signs_record_sheet/vital_signs/pulse_oximetry/spo-label"]',
  Height:
