export default {
  ...
  date_in: '[data-testid="date-picker-operationInformation.needtoreplace.finalEndDate"]',
  date_out: '[data-testid="date-picker-operationInformation.needtoreplace.finalEndDate"]',

  non_operating_room_procedure: '[data-testid="suggestion-button-needtoreplace"]',

  discharge_status: '[data-testid="radio-dischargeSummary.conditionOfDischarge"]',
